...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Demo Coloring Book Unity";
        private static string COMPANY_NAME = "1691176035110460403521";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.easyapk.coloringbookunity";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "demak1997";
        private static string KEY_ALIAS_NAME = "easyapk";
        private static string KEY_ALIAS_PASS = "demak1997";
